...
let make = () => {
  <div className="flex flex-col justify-between items-center h-screen">
    <h2 className="text-5xl font-arch decay-mask mt-[10vh] mb-[15vh] text-stone-100">
      {React.string("ABOUT")}
    </h2>
    ...
    <div
      className="flex justify-around w-4/5 max-w-72 inset-shadow-[0_0_16px_10px_rgba(28,25,23,1)]"
    >
      <a
      ...
      <p className="text-lg font-arch text-stone-100 self-end">
        {React.string("© 2026 James South")}
      </p>
    </div>
  </div>
}
