...
@set external onOpen: (Nullable.t<t>, openEventHandler) => unit = "onopen"
@set external onError: (Nullable.t<t>, errorEventHandler) => unit = "onerror"
@set external onMessage: (Nullable.t<t>, messageEventHandler) => unit = "onmessage"
@set external onClose: (Nullable.t<t>, closeEventHandler) => unit = "onclose"
@send external closeCode: (Nullable.t<t>, int) => unit = "close"
